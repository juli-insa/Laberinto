...
export default class Game extends Phaser.Scene {
  ...
  preload() {
    this.load.tilemapTiledJSON("sin nombre2", "public/assets/tilemap/sin nombre2.json");
  ...
  create() {
    const map = this.make.tilemap({ key: "sin nombre2" });
  ...
  collectStar(player, star) {
    ...
    reachMeta(player, meta) {
         if (this.score >= 5) {
        // Antes de cambiar de escena, guarda el score
